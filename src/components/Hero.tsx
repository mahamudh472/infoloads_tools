...
import { Search, Type, Code2, Image as ImageIcon, FileText, ArrowLeftRight, Calculator, Database, Globe, Shield } from "lucide-react";
          ...
          <div className="lg:col-span-7 flex flex-col justify-center text-left">
            ...
            <div className="mt-8 max-w-lg">
              ...
              >
                ...
                <button className="flex h-11 w-11 items-center justify-center rounded-lg bg-indigo-600 dark:bg-indigo-500 text-white shadow-md shadow-indigo-600/15 hover:bg-indigo-500 transition-colors">
