...
export default function CodeWorkspace({ tool }: CodeWorkspaceProps) {
  const {
    inputText,
    setInputText,
    outputText,
  ...
  const inputActions = (
    <>
      ...
      <button
        ...
        className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-xs font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors shadow-xs cursor-pointer"
      >
  ...
  const outputActions = (
    <>
      <button
        onClick={handleCopy}
        disabled={!outputText}
        className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-xs font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-750 disabled:opacity-50 transition-colors shadow-xs cursor-pointer"
      >
        {copied ? (
          <>
