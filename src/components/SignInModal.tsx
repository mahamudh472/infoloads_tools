        ...
        {success ? (
          ...
          <div className="flex flex-col gap-4">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">Manage your favorites and unlock cloud configurations.</p>
            </div>
            ...
            <div className="relative flex items-center justify-center my-1">
              ...
              <span className="relative bg-card px-3 text-[10px] font-semibold text-muted-foreground uppercase">or continue with</span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                onClick={() => {
                  setLoading(true);
                  setTimeout(() => { setLoading(false); setSuccess(true); setTimeout(() => { setSuccess(false); onClose(); }, 1500); }, 800);
                }}
